...
1. Matchmaking completes, user is assigned initial role of coder.
...
4. Randomly once through the match, user roles switch.
...
2. User signs up with their email and password, selecting a username.
3. Database record is created with user's information, stored securely.
